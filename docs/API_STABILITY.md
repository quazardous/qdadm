...
| `src/auth/oauth/` | `OAuthCodeAdapter`, `GoogleOAuthAdapter`, PKCE helpers, `OAuthCallbackPage` | New in this line; the backend contract is settled but the front shape has one consumer so far |
