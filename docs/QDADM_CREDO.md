...
See [Security docs](./security.md) for full auth flow.
...
| Doc | Topic |
|-----|-------|
| [CRUD Pages](./crud.md) | List, form, show, children, recipes |
| [Architecture](./architecture.md) | PAC pattern, layer separation, no-template-ish |
| [Extension](./extension.md) | Overview of all extension mechanisms |
| [Zones](./zones.md) | UI composition via named slots |
| [Signals](./signals.md) | Event-driven cross-module communication, EventRouter |
| [Hooks](./hooks.md) | Drupal-inspired lifecycle hooks |
| [Deferred](./deferred.md) | Async coordination, warmup |
| [Security](./security.md) | Scope vs silo, AuthAdapter |
