 ...
 *
 * @param registry - The zone registry instance
 ...
 * ```
 */
export function registerStandardZones(registry: ZoneRegistry): ZoneRegistry {
  // Layout zones
 ...
 *
 * @returns Array of all standard zone names
 */
export function getStandardZoneNames(): string[] {
